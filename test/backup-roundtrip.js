...
import { launchBrowser, blobStorageWorks, noteBlobSkip, BROWSER_NAME, listenOnEphemeralPort } from "./browser.js";
...
const MIME = {
  ...
  ".jpeg": "image/jpeg", ".jpg": "image/jpeg", ".webmanifest": "application/manifest+json",
