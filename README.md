...
- In **Full image**, tap a word to select it, then drag from the small handle that appears to move it, or its corner handle to resize it - freely and independently, with Undo and Redo for every move and resize
...
4. In **Full image**, tap a word to select it, then drag its handle to move it or its corner handle to resize it. Undo and Redo step back and forward through those changes.
